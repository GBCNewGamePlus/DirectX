...
public:
	...
	///</summary>
    MeshData CreateGrid(float width, float depth, uint32 m, uint32 n, float widthLag, float depthLag);
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////
	MeshData CreateStar();
	MeshData CreateWedge();
	MeshData CreateTriPrism();
	MeshData CreatePyramid();
	MeshData CreateHexagon();
	MeshData CreateSimsIndicator();
	MeshData CreateCone();

	MeshData CreateCube();
	MeshData CreateMySphere();
