...
void LitColumnsApp::BuildRenderItems()
{
	...
	starRitem->World = MathHelper::Identity4x4();
	XMStoreFloat4x4(&starRitem->TexTransform, XMMatrixScaling(8.0f, 8.0f, 1.0f)*XMMatrixTranslation(1.0f, 1.0f, 1.0f));
	starRitem->ObjCBIndex = 0;
...
//	mAllRitems.push_back(std::move(starRitem));
	...
	XMStoreFloat4x4(&wedgeRitem->World, XMMatrixScaling(8.0f, 8.0f, 1.0f)*XMMatrixTranslation(1.0f, 1.0f, 1.0f));
